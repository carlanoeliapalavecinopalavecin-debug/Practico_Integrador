    ...
    public class AccesoMySql : IAccesoDatos
    {
        ...
        public void EjecutarOperaciones()
        {
            ...
            try
            {
                ...
                Console.WriteLine("\n✏️ U1: Actualización - Aumentar 10% precio Categoría 1");
                ...
                Console.WriteLine("\n🗑️ D1: Eliminación - Borrar línea Pedido 1 - Producto 1");
        ...
        public void DemostrarRollback()
        {
            ...
            try
            {
                ...
                Console.WriteLine("✏️ Precio cambiado temporalmente a 999.99 (solo en memoria)");
                throw new Exception("❌ ERROR SIMULADO: Algo salió mal, se deshace todo");
            }
            catch (Exception ex)
            {
                Console.WriteLine($"⚠️ Excepción capturada: {ex.Message}");
